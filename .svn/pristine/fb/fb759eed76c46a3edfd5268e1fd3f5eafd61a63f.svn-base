                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p><?php echo $arrview[0]->doctor_specialty; ?></p>
                                        </div>


                                        <div class="col-md-6">
                                            <label class="label-control" style="font-weight:bold;"> Doctor Name :</label> <br>
                                            <p> <?php echo $arrview[0]->doctor_name;?></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p><?php echo $arrview[0]->appointment_date;?></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="label-control" style="font-weight:bold;">Appointment Time :</label><br>
                                        <p><?php echo $arrview[0]->appointment_time; ?><p>
                                        </div>
                                    </div>
                                    <div class="row">
<!--                                        <div class="col-md-6">
                                            <label class="label-control" style="font-weight:bold;">Status :</label><br> 
                                            <p><?php echo $arrview[0]->first_name; ?><p>
                                        </div>-->
