...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('admin/viewdoctor'); ?>">Doctor List</a></li>   
...
<!--                <h3 class="card-title"> <?php echo!empty($updatedata->id) ? "Update Yoga Instructors" : "Add New Yoga Instructors"; ?> </h3>-->
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col">
                        <form novalidate action="<?php echo base_url('admin/doctor-add'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="speciality_id">
                                                    ...
                                                    if ($doctor_speclityobj->id == $updatedata->speciality_id) {
                                                        echo "selected";
                                                    }
    ...
    foreach ($doctor_speclity as $arrcenternameobj) {
        ?>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <input type="file"  name="doctor_image" <?php echo empty($updatedata->id) ? "required data-validation-required-message='This field is required'" : ''; ?> class="form-control"> <div class="help-block"></div></div>
                                    <input type="hidden"  id="old"  name="old_image"  value="<?php echo!empty($updatedata->doctor_image) ? $updatedata->doctor_image : ''; ?>">
                                    <?php
                                    if (!empty($updatedata->doctor_image)) {
                                     ?>

                                        <div>
                                            <img src="<?php if (!empty($updatedata)) {
                                            echo!empty($updatedata->doctor_image) ? base_url() . '/' . DOCTOR_IMAGE_PATH . '/500x600_' . $updatedata->doctor_image : '';
                                        } ?>" height="150" width="150">
                                        </div>
                               <?php } ?>
                                </div>
                                <div class="col-sm-4">
                                     <h5>Home Image<span class="text-danger"></span></h5>
                                   
                                    <div class="c-inputs-stacked">
                                        <label class="inline custom-control custom-checkbox block">  
                                            <input name="is_home" type="checkbox" class="custom-control-input ishome" value="<?php echo !empty($updatedata->is_home)?'1':'0';?>" <?php echo !empty($updatedata->is_home)?'Checked':'0';?>> <span class="custom-control-indicator"></span> <span class="custom-control-description ml-0"></span></label>
