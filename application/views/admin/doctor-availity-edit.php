...
<!--                <h3 class="card-title mt-10"> <?php
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col">
                        <form novalidate action="<?php echo base_url('admin/doctor-availity-edit'); ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" name="doctor_id">
                                            ...
                                            foreach ($doctor_list as $doctor_speclityobj) {
                                                ?>
                                                <option value="<?php echo $doctor_speclityobj->id; ?>" <?php  if(($doctor_speclityobj->id==$CheckAvalityexits[0]->doctor_id)) { echo "selected";}?>
