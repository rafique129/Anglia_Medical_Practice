...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('admin/patient'); ?>">New User View</a></li>
        </ol>
    </section>
                    ...
                    <div class="box-header">
                        <div class="row">
                            <div class="col-md-10 col-sm-9">
                                <h3 class="box-title mt-10">All Request</h3>
                                           ...
                                           <td><?= $arrviewobj->contact_number; ?></td>
                                              ...
                                              <!--<td><?php echo $arrviewobj->appointment_time;?></td>--> 
                                               <td>
                                                ...
                                                <a href="<?php echo base_url('admin/patient-detail' . '/' . $arrviewobj->id); ?>" > <button class="btn btn-social-icon btn-circle"><i class="fa fa-eye"></i></button></a>
