                        ...
                        <div class="active tab-pane" id="timeline">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="label-control" style="font-weight:bold;">Doctor Speciality :</label> <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label class="label-control" style="font-weight:bold;"> Image :</label><br>
                                             <img src="<?php if(!empty($arrviewobj)){echo !empty($arrviewobj->image)?base_url().'/'.CENTER_IMAGE_PATH .'/500x306_'. $arrviewobj->image:'';}?>" height="50" width="50">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="label-control" style="font-weight:bold;">  Creation Date :</label><br>
