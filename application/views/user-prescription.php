                ...
                <div class="container">
                    <div class="row">
                        ...
                        <ul class="list user-profile-nav list-unstyled list-group">                            
                            ...
                            <li class="list-group-item"><a href="<?php echo base_url('user-prescription');?>"><i class="fa fa-clock-o"></i>&nbsp;&nbsp;User Prescription</a>
                            </li> 
                        </ul>
                    </aside>                     
               </div>
...
<!--                                        <td>
                                 ...
                                 <tr>
<!--                                     <td>
                                   <?php echo $prescriptionobj->patient_name;?>
                                     </td>-->
                                     <td>
                                   <?php echo $prescriptionobj->doctor_specialty;?>
                                     </td>
                                     <td>
                                   <?php echo $prescriptionobj->doctor_name;?>
                                     </td>
                                     <td>
                                    <?php echo date("d M Y",strtotime($prescriptionobj->Issue_Date));?> 
                                     </td>
                                     <td>
                                      <?php echo date("d M Y",strtotime($prescriptionobj->end_date));?>
                                     </td>
                                     <td>
                                      <a href="<?php echo base_url('pdf/'.$prescriptionobj->patient_id);?>" target="_blank">Read more</a>
                                     </td>
                                 </tr>
                                     <?php } } else{?>
                                 <tr>
